...
<ul> 
 <li><code>FoodRatings(String[] cuisineFoods, String[] cuisines, int[] ratings)</code> 初始化系统。食物由 <code>cuisineFoods</code>、<code>cuisines</code> 和 <code>ratings</code> 描述，长度均为 <code>n</code> 。 </li>
</ul>

    <ul>
    	<li><code>cuisineFoods[i]</code> 是第 <code>i</code> 种食物的名字。</li>
...
<ul> 
 ...
 <li><code>n == cuisineFoods.length == cuisines.length == ratings.length</code></li> 
 <li><code>1 &lt;= cuisineFoods[i].length, cuisines[i].length &lt;= 10</code></li> 
 <li><code>cuisineFoods[i]</code>、<code>cuisines[i]</code> 由小写英文字母组成</li> 
 <li><code>1 &lt;= ratings[i] &lt;= 10<sup>8</sup></code></li> 
 <li><code>cuisineFoods</code> 中的所有字符串 <strong>互不相同</strong></li> 
...
<div><div>Related Topics</div><div><li>设计</li><li>数组</li><li>哈希表</li><li>字符串</li><li>有序集合</li><li>堆（优先队列）</li></div></div><br><div><li>👍 60</li><li>👎 0</li></div>